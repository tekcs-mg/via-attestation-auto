        ...
        <div className="border border-black p-2 mt-1 text-[9px] space-y-2">
            <div className="flex justify-between">
                <div className="flex items-center gap-2 w-full">
                  ...
                  <div className="font-bold text-black flex-grow text-center border-b-2 border-sky-500 pb-1">{attestation.numeroPolice}</div>
                </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="font-bold text-black flex-grow text-center border-b-2 border-sky-500 pb-1">{attestation.souscripteur}</div>
            </div>
            <div className="flex items-center gap-2">
              <BilingualLabel malagasy="Fonenana" francais="Adresse" />
              <div className="font-bold text-black flex-grow text-center border-b-2 border-sky-500 pb-1">{attestation.adresse}</div>
            </div>
            <div className="flex justify-between items-end pt-1">
                <div className="flex items-end gap-2 flex-grow">
                  <BilingualLabel malagasy="Manan-kery" francais="Valable du" />
                  <div className="font-bold text-black flex-grow text-center border-b-2 border-sky-500 pb-1">{format(new Date(attestation.dateEffet), 'dd MMMM yyyy', { locale: fr })}</div>
                </div>
                <div className="flex items-end gap-2 flex-grow">
                  <BilingualLabel malagasy="ka hatramin'ny" francais="au" />
                  <div className="font-bold text-black flex-grow text-center border-b-2 border-sky-500 pb-1">{format(new Date(attestation.dateEcheance), 'dd MMMM yyyy', { locale: fr })}</div>
                </div>
            </div>
        </div>

        <div className="flex mt-1 text-[9px] flex-grow">
          <div className="w-[70%] border border-black p-2">
        ...
        <div className="h-1/2 p-2 flex flex-col">
            <div className="text-[10px] text-left">
                ...
                <div className="mt-2 grid grid-cols-[auto_1fr] items-center gap-x-2 gap-y-2">
                    ...
                    <div className="font-bold text-black text-end border-b-2 border-sky-500 pb-1">{attestation.marque}</div>

                    <span className="font-bold text-blue-900">N° IMM :</span>
                    <div className="font-bold text-black text-end border-b-2 border-sky-500 pb-1">{attestation.immatriculation}</div>

                    <span className="font-bold text-blue-900">VALIDITE DU :</span>
                    <div className="font-bold text-black text-end border-b-2 border-sky-500 pb-1">{format(new Date(attestation.dateEffet), 'dd/MM/yyyy')}</div>

                    <span className="font-bold text-blue-900">AU :</span>
                    <div className="font-bold text-black text-end border-b-2 border-sky-500 pb-1">{format(new Date(attestation.dateEcheance), 'dd/MM/yyyy')}</div>
                </div>
            </div>
