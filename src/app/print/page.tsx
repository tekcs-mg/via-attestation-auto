...
// Ce composant principal reste un Server Component pour une performance optimale.
export default function PrintPage() {
  return (
    // On enveloppe le composant client dans une balise Suspense.
    // Le 'fallback' s'affiche pendant que le composant client se charge.
    <Suspense fallback={<div className="flex items-center justify-center h-screen">Chargement des paramètres...</div>}>
